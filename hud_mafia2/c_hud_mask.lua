...
local posx = screenWidth-20-(width_map*height_hd)+10
local posy = screenHeight-(width_map*height_hd)-5
local height = width_map*height_hd-20
...
addEventHandler( "onClientRender", root,
	function()
		...
		if vehicle then--отображение скорости авто
			...
			if fuel <= 15 then
				dxDrawImage ( screenWidth-20-width_new-width_map*height_hd, screenHeight-width_new-15, width_new, width_new, "hud/low_fuel.png" )
			end
		end
		...
		-- Draw
		--
		local width_new = width_map*height_hd
		...
		dxDrawCircle ( (screenWidth-20-width_new)+(width_new/2), (screenHeight-width_new-15)+(width_new/2), 72*height_hd, 83.0, (-166.0/getPedMaxHealth(localPlayer))*getElementHealth(localPlayer)+83, tocolor( 111,154,104,255 ), tocolor( 111,154,104,255 ) )
		dxDrawCircle ( (screenWidth-20-width_new)+(width_new/2), (screenHeight-width_new-15)+(width_new/2), 72*height_hd, 97.0, (166.0/100)*getPedArmor(localPlayer)+97, tocolor( 0, 102, 255,255 ), tocolor( 0, 102, 255,255 ) )
		...
		dxDrawImage( screenWidth-20-(width_new/2)-(16*height_hd/2), screenHeight-(width_new/2)-(16*height_hd/2)-15, 16*height_hd, 16*height_hd, "images/blips/2.png", -playerrot+camrot,0,0, tocolor(255,255,255,255) )
	end
)