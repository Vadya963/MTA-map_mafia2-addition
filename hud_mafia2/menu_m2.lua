local menu_m2_table_text = {
	...
	--triggerServerEvent
	--тс
	["завести"] = {"event", "e_server_car_engine", "true"},
	["заглушить"] = {"event", "e_server_car_engine", "false"},

	["открыть"] = {"event", "e_server_car_door", "false"},
	["закрыть"] = {"event", "e_server_car_door", "true"},

	["включить"] = {"event", "e_server_car_light", "true"},
	["выключить"] = {"event", "e_server_car_light", "false"},

	["открыть капот"] = {"event", "e_server_car_trunk_and_hood", "true,hood"},
	["закрыть капот"] = {"event", "e_server_car_trunk_and_hood", "false,hood"},
	["открыть багажник"] = {"event", "e_server_car_trunk_and_hood", "true,trunk"},
	["закрыть багажник"] = {"event", "e_server_car_trunk_and_hood", "false,trunk"},

	--анимации														anim 1, anim 2, loop anim true/false
	["запуск поднять руки"] = {"event", "e_server_anim_player", "rob_bank,shp_handsup_scr,false"},
	["запуск сесть 1"] = {"event", "e_server_anim_player", "attractors,stepsit_loop,false"},
	["запуск сесть 2"] = {"event", "e_server_anim_player", "ped,seat_idle,false"},
	["запуск ждать"] = {"event", "e_server_anim_player", "playidles,time,true"},
	["запуск курить"] = {"event", "e_server_anim_player", "smoking,m_smk_drag,true"},
	["запуск боль"] = {"event", "e_server_anim_player", "CRACK,crckdeth2,true"},
	["запуск махать рукой"] = {"event", "e_server_anim_player", "on_lookers,wave_loop,true"},
	["запуск йога"] = {"event", "e_server_anim_player", "park,tai_chi_loop,true"},
	["запуск заложник"] = {"event", "e_server_anim_player", "ped,duck_cower,true"},
	["запуск праздновать"] = {"event", "e_server_anim_player", "CASINO,manwinb,one"},
	["запуск смеяться"] = {"event", "e_server_anim_player", "RAPPING,Laugh_01,one"},
	["запуск показать фак"] = {"event", "e_server_anim_player", "RIOT,RIOT_FUKU,one"},
	["запуск playBoy"] = {"event", "e_server_anim_player", "ped,WALK_civi,walk"},
	["запуск пьяный"] = {"event", "e_server_anim_player", "ped,WALK_drunk,walk"},
	["запуск толстый"] = {"event", "e_server_anim_player", "ped,WALK_fat,walk"},
	["остановить анимацию"] = {"event", "e_server_anim_player", "nil,nil,false"},
}
